          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              >
                ...
                <div className="listing-content">
                  <h3 className="title">
                    <Link href="/listing-details-1">Food House</Link>
                  </h3>
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <div className="listing-content">
                  <h3 className="title">
                    <Link href="/listing-details-1">State Museum</Link>
                  </h3>
                  <ul className="ratings ratings-three">
                    <li className="star">
                      <i className="flaticon-star-1" />
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <div className="listing-content">
                  <h3 className="title">
                    <Link href="/listing-details-1">Party Center</Link>
                  </h3>
                  <ul className="ratings ratings-three">
                    <li className="star">
                      <i className="flaticon-star-1" />
            ...
            <div className="col-lg-6">
              ...
              >
                ...
                <div className="listing-content">
                  <h3 className="title">
                    <Link href="/listing-details-1">Gaming Place</Link>
                  </h3>
                  <ul className="ratings ratings-three">
                    <li className="star">
                      <i className="flaticon-star-1" />
      ...
      <section className="listing-grid-area pt-110">
        ...
        >
          ...
          <div className="listing-item listing-grid-item-two">
            ...
            <div className="listing-content">
              <h3 className="title">
                <Link href="/listing-details-6">Pizza Recipe</Link>
              </h3>
              <p>Popular restaurant in california</p>
              <span className="phone-meta">
                <i className="ti-tablet" />
                ...
                <div className="entry-content text-center">
                  ...
                  <h3 className="title">
                    <Link href="/blog-details">
                      Sociis sapie justo feugiat purus adipiscing
                    </Link>
                  </h3>
